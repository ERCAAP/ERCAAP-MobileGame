...
namespace V.Folders
{
    class VFoldersMenu
    {
        ...
        public static bool hierarchyLinesEnabled { get => EditorPrefs.GetBool("vFolders-hierarchyLinesEnabled", true); set => EditorPrefs.SetBool("vFolders-hierarchyLinesEnabled", value); }
        public static bool clearerRowsEnabled { get => EditorPrefs.GetBool("vFolders-clearerRowsEnabled", true); set => EditorPrefs.SetBool("vFolders-clearerRowsEnabled", value); }
        public static bool minimalModeEnabled { get => EditorPrefs.GetBool("vFolders-minimalModeEnabled", true); set => EditorPrefs.SetBool("vFolders-minimalModeEnabled", value); }
