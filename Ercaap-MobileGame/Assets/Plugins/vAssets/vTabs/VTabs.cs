...
using static V.VTabs.Libs.VUtils;
using static V.VTabs.Libs.VGUI;
...
namespace V.VTabs
{
    public static class VTabs
    {
        ...
        static Stack<TabInfo> tabInfosForReopening = new();
        ...
        [System.Serializable]
        class TabInfoList { public List<TabInfo> list = new(); }
        ...
        static Dictionary<int, Texture2D> adjustedObjectIconsBySourceIid = new();
